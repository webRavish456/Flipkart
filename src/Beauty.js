    ...
    const nextpage=()=>
    {
        ...
        return (
            <>
                <div>
          <div className="write">
           <p className="h3"  style={{width:"200px",textAlign:"end"}} > Beauty, Food,</p>
           <p className="h3" style={{width:"190px",textAlign:"end"}}>Toys & more</p>
           <div className="view">VIEW ALL</div>
           </div>
           <div style={{position:"relative",marginTop:"-60px",paddingLeft:"10px"}}>
